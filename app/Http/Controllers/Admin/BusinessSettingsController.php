...
//    {
//        $branches = Branch::get(['id', 'name', 'status']);
...
//    }
    ...
    public function maintenanceModeSetup(Request $request): RedirectResponse
    {
        ...
        $this->business_setting->updateOrInsert(['key' => 'maintenance_system_setup'], [
            'value' => json_encode($selectedSystems)],
        );

        $this->business_setting->updateOrInsert(['key' => 'maintenance_duration_setup'], [
            'value' => json_encode([
        ...
        $this->business_setting->updateOrInsert(['key' => 'maintenance_message_setup'], [
            'value' => json_encode([
