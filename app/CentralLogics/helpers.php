        ...
        if ($details->count() > 0) {
            foreach ($details as $detail) {
                ...
                if (Order::find($detail->order_id)->order_type == 'pos') {
                    ...
                    if(count($detail['variation'])>0 && $detail['variation'][0]['type'] == null && $detail['variation'][0]['price'] == null && $detail['variation'][0]['stock'] == null) {
                        $detail['variation'] = null;
                    } else {
                        $detail['variation'] = (string) (isset($detail['variation'][0]) ? ($detail['variation'][0]['type'] . '-' . $detail['variation'][0]['price'] . '-' . $detail['variation'][0]['stock']) : null);
                    }
                }
