                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body text-capitalize d-flex flex-column">
                            ...
                            <div class="mt-2">
                                @if($order['order_type'] != 'pos')
                                    ...
                                    <select name="order_status" onchange="route_alert('{{route('branch.orders.status',['id'=>$order['id']])}}'+'&order_status='+ this.value,'{{translate("Change the order status to ") }}'+  this.value.replace(/_/g, ' '))" class="form-control">
                            ...
                            <div class="mt-3">
                                @if($order['order_type'] != 'pos')
                                    ...
                                    <select name="order_status" onchange="route_alert('{{route('branch.orders.payment-status',['id'=>$order['id']])}}'+'&payment_status='+ this.value,'{{translate("Change status to ")}}'+ this.value)" class="status custom-select" data-id="100147">
                            ...
                            @if($order['order_type']!='self_pickup' && $order['order_type'] != 'pos')
                                <div class="hs-unfold mt-3">
                                    <select class="form-control" name="delivery_man_id" id="select-delivery-man">
                                        ...
                                        @foreach(\App\Model\DeliveryMan::where(['branch_id'=>auth('branch')->id()])->orWhere(['branch_id'=>0])->where(['application_status' => 'approved'])->get() as $deliveryMan)
                                            <option
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h4 class="d-flex mb-0 gap-2 align-items-center"><i class="tio tio-user"></i> {{translate('Customer_Information')}}</h4>
                        </div>
                    ...
                    @if($order['order_type']!='self_pickup' && $order['order_type'] != 'pos')
                        <div class="card">
                            <div class="card-header">
                                <h4 class="d-flex mb-0 gap-2 align-items-center"><i class="tio tio-user"></i> {{translate('Delivery_Address')}}</h4>
                            </div>
            ...
            <div class="modal-content">
                ...
                @if(isset($address))
                    <form action="{{route('branch.order.update-shipping',[$order['delivery_address_id']])}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="row mb-3">
                                <label for="requiredLabel" class="col-md-2 col-form-label input-label text-md-right">{{translate('type')}}</label>
                                <div class="col-md-10 js-form-message">
                                    <input type="text" class="form-control" name="address_type" value="{{$address['address_type']}}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="requiredLabel" class="col-md-2 col-form-label input-label text-md-right">{{translate('contact')}}</label>
                                <div class="col-md-10 js-form-message">
                                    <input type="text" class="form-control" name="contact_person_number" value="{{$address['contact_person_number']}}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="requiredLabel" class="col-md-2 col-form-label input-label text-md-right">{{translate('name')}}</label>
                                <div class="col-md-10 js-form-message">
                                    <input type="text" class="form-control" name="contact_person_name" value="{{$address['contact_person_name']}}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="requiredLabel" class="col-md-2 col-form-label input-label text-md-right">{{translate('address')}}</label>
                                <div class="col-md-10 js-form-message">
